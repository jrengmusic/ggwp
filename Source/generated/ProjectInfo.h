 ...
 */
    ...
    static constexpr const char* const projectName      { "ggwp"                                             };///< GlyphSheet Generation Workflow Protocol
    ...
    static constexpr const char* const versionString    { "1.0"                                              };///< Product version string.
